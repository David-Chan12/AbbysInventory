...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO producto (nombre, precio, cantidad_disponible, fecha_creacion, fecha_actualizacion, estado, descripcion) 
            VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    // Vincular parámetros
    $stmt->bind_param("sddssss", $nombre, $precio, $cantidad_disponible, $fecha_actual, $fecha_actual, $estado, $descripcion);
...
<head>
    ...
    <title>Agregar Producto - Abby Cookies & Cakes</title>
            ...
            <div class="report-container">
                ...
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" style="max-width: 600px; margin: 0 auto;">
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="text" id="nombre" name="nombre" required style="width: 100%; padding: 8px; border-radius: 4px; border: 1px solid #ccc;">
                    </div>

                    <div style="margin-bottom: 15px;">
                        <label for="precio" style="display: block; margin-bottom: 5px; font-weight: bold;">Precio:</label>
                        <input type="number" id="precio" name="precio" step="0.01" required style="width: 100%; padding: 8px; border-radius: 4px; border: 1px solid #ccc;">
                    </div>

                    <div style="margin-bottom: 15px;">
                        <label for="cantidad_disponible" style="display: block; margin-bottom: 5px; font-weight: bold;">Cantidad Disponible:</label>
                        <input type="number" id="cantidad_disponible" name="cantidad_disponible" required style="width: 100%; padding: 8px; border-radius: 4px; border: 1px solid #ccc;">
                    </div>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <textarea id="descripcion" name="descripcion" rows="4" style="width: 100%; padding: 8px; border-radius: 4px; border: 1px solid #ccc;"></textarea>
                    </div>

                    <div style="text-align: center; margin-top: 20px;">
                        <button type="submit" class="mostrardatos">Guardar Producto</button>
